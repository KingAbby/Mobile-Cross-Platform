    ...
    async function takePhoto() {
        if (cameraRef) {
            try {
                ...
                console.log('Preparing to upload photo to Supabase storage...');                // Actually upload the image to Supabase storage
                try {
                ...
                console.log('Image public URL:', imageUrl);// Save metadata to Supabase database
                try {
                    console.log('Attempting to save to Supabase database...');
                    const dataToInsert = {
                        photo_url: imageUrl, // This would normally be the real URL after upload
